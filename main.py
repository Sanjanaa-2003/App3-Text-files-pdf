...
filepaths = glob.glob("files/*.txt")    #imports everything from files
# Create one PDF file
...
for filepath in filepaths:
    ...
    pdf.cell(w=50, h=8, txt=name, ln=1) #w=0 spans from left to right across the entire screen; h is height of each row;
